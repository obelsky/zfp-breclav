...
export const metadata: Metadata = {
  ...
  title: {
    default: 'Finanční poradenství Břeclav | ZFP GROUP - Hypotéky, Investice, Pojištění',
    template: '%s | ZFP Břeclav',
  },
  description: 'Finanční poradenství v Břeclavi ✓ Hypotéky ✓ Investice ✓ Pojištění ✓ 10 let zkušeností na jižní Moravě ✓ Osobní přístup ✓ Nezávislé poradenství ✓ ZFP GROUP',
  keywords: [
  ...
  openGraph: {
    ...
    description: 'Finanční poradenství v Břeclavi - hypotéky, investice, pojištění. 10 let zkušeností, osobní přístup, nezávislé poradenství.',
    images: [
      {
        url: '/og-image.jpg',
        width: 1200,
  ...
  twitter: {
    ...
    title: 'Finanční poradenství Břeclav | ZFP GROUP',
    description: 'Finanční poradenství v Břeclavi - hypotéky, investice, pojištění. 10 let zkušeností na jižní Moravě.',
    images: ['/og-image.jpg'],
  },
  robots: {
    index: true,
