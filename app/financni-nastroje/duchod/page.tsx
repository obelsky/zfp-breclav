...
export default function DuchodPage() {
  ...
  // State pension estimate (very rough)
  const statePension = 18000; // Average state pension per month
  ...
  const gapPercent = (gap / totalNeeded) * 100;
  ...
  return (
    <>
      <section className="pt-24 lg:pt-32 pb-20 min-h-screen">
        <div className="container-custom">
          ...
          >
            ...
            <h1 className="mb-6">Důchodová kalkulačka</h1>
            <p className="text-xl text-white/70 max-w-3xl leading-relaxed">
              Spočítejte si, kolik potřebujete naspořit na důchod. Státní důchod nebude stačit.
            </p>
          </motion.div>
                ...
                <div className="space-y-6">
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="text-sm font-medium text-white/80">Současný věk</label>
                      <span className="text-lg font-bold text-zfp-gold">{currentAge} let</span>
                    </div>
                    <input
                      type="range"
                      min="20"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="text-sm font-medium text-white/80">Věk odchodu do důchodu</label>
                      <span className="text-lg font-bold text-zfp-gold">{retirementAge} let</span>
                    </div>
                    <input
                      type="range"
                      min="60"
                  ...
                  <div>
                    <div className="flex justify-between items-center mb-3">
                      <label className="text-sm font-medium text-white/80">Požadovaný měsíční příjem v důchodu</label>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-blue-500/10 border border-blue-500/20 rounded-xl p-6">
                    ...
                    <div className="space-y-2 text-sm">
                      ...
                      <div className="flex justify-between">
                        <span className="text-white/70">Očekávaná délka důchodu:</span>
                  ...
                  <div className="bg-yellow-500/10 border border-yellow-500/20 rounded-xl p-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="text-sm text-white/70">Odhadovaný státní důchod měsíčně</div>
                      <div className="mt-4 text-xs text-white/50">
                        Průměrný český důchod je {formatCurrency(statePension)}. To je pouze {((statePension / currentSalary) * 100).toFixed(0)}% vašeho současného příjmu.
                      </div>
                    </div>
                  </div>
                  ...
                  >
                    ...
                    <div className="text-sm text-white/70">Musíte pokrýt ze svých úspor každý měsíc</div>
                  </motion.div>
                  ...
                  <div className="bg-green-500/10 border border-green-500/20 rounded-xl p-6">
                    <h3 className="text-lg font-semibold mb-4 text-green-300">Kolik nasp oříte</h3>
                  ...
                  {gap > 0 ? (
                    ...
                    >
                      ...
                      <div className="text-sm text-white/70">
                        To je {gapPercent.toFixed(0)}% z celkové potřeby
                      </div>
                    </motion.div>
                  ) : (
                    <motion.div 
      ...
      <ContactForm
        ...
        title="Důchodové plánování - konzultace"
