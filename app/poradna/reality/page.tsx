...
export const metadata: Metadata = {
  title: 'Reality | Finanční poradna | ZFP GROUP Břeclav',
  description: 'Koupě, prodej a financování nemovitostí. Rady od certifikovaných poradců.',
};

const CATEGORY_SLUG = 'reality';
const CATEGORY_TITLE = 'Reality';
const CATEGORY_DESC = 'Koupě, prodej a financování nemovitostí';
    ...
    <section className="pt-24 lg:pt-32 pb-20 min-h-screen">
      <div className="container-custom">
        ...
        <div className="mb-16">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-zfp-orange mb-6">{CATEGORY_TITLE}</h1>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {articles.map((article) => (
                <Link key={article.id} href={`/poradna/${article.slug}`}
                  className="group bg-white/5 border border-white/10 rounded-xl overflow-hidden hover:border-zfp-orange/30 transition-all">
                  ...
                  <div className="p-6">
                    <h3 className="text-xl font-semibold mb-2 group-hover:text-zfp-orange transition-colors">{article.title}</h3>
        ...
        <div className="bg-gradient-to-br from-zfp-orange/10 to-zfp-dark border border-zfp-orange/20 rounded-2xl p-12 text-center">
          ...
          <p className="text-xl text-white/70 mb-8 max-w-2xl mx-auto">Spojte se s námi a probereme financování nemovitostí</p>
          <Link href="/kontakt" className="inline-block px-10 py-5 bg-zfp-orange hover:bg-zfp-orange-hover text-white font-medium tracking-wider uppercase rounded-lg transition-all">
            Kontaktovat poradce
          </Link>
        </div>
      </div>
